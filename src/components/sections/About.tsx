      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              1996年、東京生まれ。2019年に大学を卒業し、生命保険会社に入社しました。
            </p>
            <p
              className="text-[16px]"
              style={{ fontWeight: 400, lineHeight: 1.8, color: "var(--on-surface-variant)" }}
            >
              配属された本社部署で最初に任されたのは、お客さまの声を1件ずつ読むことでした。たくさんの「生活者の声」に触れるうちに、その声を自社のサービスに活かしたいという思いが強くなり、2025年に社内のデザイン組織へ。今はUXコンセプトの設計、UI実装、デザインシステムの運用まで、担当しています。
            </p>
            <p
              className="text-[16px]"
              style={{ fontWeight: 400, lineHeight: 1.8, color: "var(--on-surface-variant)" }}
            >
              「なぜこの画面なのか」を、事業の論理とユーザーの感情の両面から語れるデザイナーを目指しています。
            </p>
          </div>
