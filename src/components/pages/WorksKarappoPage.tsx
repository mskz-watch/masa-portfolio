...
const sections: Section[] = [
  ...
  },
  {
    ...
    content: [
      {
        text: "はじめは、自分の冷蔵庫で、ワクワクして買ったはずの調味料が結局使い切れず、買い物のたびに小さな罪悪感がある──そんな感覚からリサーチを始めました。",
      },
      {
        text: "調べてみると、Oisixの調査で調味料は家庭内フードロスの第2位。10人に6人が調味料を余らせています（出典：Oisix 家庭内フードロスについて（2023年））。",
      },
    ],
  },
  {
    ...
    content: [
      {
        text: "最初は「使い切れないのはズボラだからだ」と思っていました。でも話を聞くほどに、原因は性格ではなく、「この調味料はここにしか使えない」という思い込みの方にあると見えてきました。",
      },
      {
        text: "実は、多くの調味料は想像より汎用性が高いです。ドレッシングは炒め物以外にも合うし、オイスターソースは中華飯以外の料理にも効きます。「専用」の壁を変えてあげれば、賞味期限前に使い切れる可能性はずっと広がります。",
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: "① 使い切る達成感を、小さな何度もとどける\nゲージに近づく過程をスタンプやアニメーションで見えるようにする。使い切った感覚を何度でも積み重ねる設計にしました。",
      },
      {
        text: "② 管理はアプリ側で持つ。使う人に考えさせない\n時期になれば、アプリが察して必要なタイミングだけ通知します。ユーザーを「管理者」にしない──この1点を徹底しました。",
      },
      {
        text: "③ 「こんな使い方があったの?」が増える\n手持ちの調味料から、少し意外なレシピを提案します。「買いレパートリー」ではなく、「使いレパートリー」を広げるのが狙いです。",
      },
    ],
  },
  {
