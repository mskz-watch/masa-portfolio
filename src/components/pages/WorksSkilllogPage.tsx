...
const sections: Section[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: "リスキリングという言葉は広まりましたが、日常業務のなかでいつの間にか身についている種類のスキルは、今も記録されることなく流れていきます。それを残したいと考えたのが、スキログです。",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        text: "スキログは、そこに当てるサービスとして設計しました。日常の小さな前進を記録し、自分がどこまで来たかを見えるようにする──そんな体験を目指しています。",
      },
    ],
  },
  {
    ...
    content: [
      {
        text: "デザインテーマは、キャリアをじっくり積み上げてきた人に寄り添う印象を目指しました。",
      },
      {
        list: [
  ...
  },
  {
    ...
    content: [
      {
        text: "課題発見からデザイン実装まで、仮想クライアント（ReValue）への企画・提案というかたちで通して経験したプロジェクトです。仕事で実際に感じていたことを、そのまま起点にできたのが、何かの収穫でした。",
      },
      {
        text: "残ったのは、次の2つです。",
        list: [
          "調査で見つけた課題を、相手に納得してもらえる順番で提示する感覚",
          "デザインとコーディングを、同じ手で行う実際の感覚",
        ],
      },
    ],
  },
