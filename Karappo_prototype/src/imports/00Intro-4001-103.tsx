import svgPaths from "./svg-nn5y6l8y35";
...
function IOsStatusBar() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-0 pl-[52px] pr-[32px] py-[16px] top-0 w-[393px]" data-name="iOS Status Bar">
      <p className="font-['SF_Pro_Text:Semibold',sans-serif] leading-[22px] not-italic relative shrink-0 text-[17px] text-black text-center whitespace-nowrap">9:41</p>
      <Wrapper />
    </div>
  );
}
...
function Group() {
  return (
    <div className="col-1 h-[87.912px] ml-0 mt-[53.89px] relative row-1 w-[333.819px]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 333.819 87.912">
        <g id="Group">
          <g id="Group_2">
            <path d={svgPaths.p8e3f270} fill="var(--fill-0, white)" id="Vector" />
            <path d={svgPaths.p38909440} fill="var(--fill-0, white)" id="Vector_2" />
            <path d={svgPaths.p2a71a900} fill="var(--fill-0, white)" id="Vector_3" />
            <path d={svgPaths.p2636cb80} fill="var(--fill-0, white)" id="Vector_4" />
            <path d={svgPaths.p23cabd00} fill="var(--fill-0, white)" id="Vector_5" />
            <path d={svgPaths.p12c96100} fill="var(--fill-0, white)" id="Vector_6" />
          </g>
          <path d={svgPaths.p39f17d00} fill="var(--fill-0, white)" id="Vector_7" />
          <path d={svgPaths.p1ed05900} fill="var(--fill-0, white)" id="Vector_8" />
          <path d={svgPaths.p15b6c500} fill="var(--fill-0, white)" id="Vector_9" />
          <path d={svgPaths.p1f04e400} fill="var(--fill-0, white)" id="Vector_10" />
          <path d={svgPaths.p3e70d280} fill="var(--fill-0, white)" id="Vector_11" />
          <path d={svgPaths.p1471b440} fill="var(--fill-0, white)" id="Vector_12" />
          <path d={svgPaths.p324e2580} fill="var(--fill-0, white)" id="Vector_13" />
          <path d={svgPaths.p17ce0000} fill="var(--fill-0, white)" id="Vector_14" />
        </g>
      </svg>
    </div>
  );
...
function Group1() {
  return (
    <div className="col-1 h-[59.492px] ml-[29px] mt-0 relative row-1 w-[63.849px]">
...
function HomeView() {
  return (
    <div className="absolute bg-[#fafaf9] h-[855.995px] left-0 overflow-clip top-[54px] w-[393px]" data-name="HomeView">
      ...
      <p className="absolute font-['Rounded_Mplus_1c:ExtraBold',sans-serif] leading-[33px] left-[103px] not-italic text-[42.429px] text-white top-[381px] tracking-[-0.5179px] whitespace-nowrap">使い切る</p>
      <p className="absolute font-['Rounded_Mplus_1c:ExtraBold',sans-serif] leading-[28px] left-[103px] not-italic text-[24px] text-white top-[450px] tracking-[-0.4395px] whitespace-nowrap">って気分が良い</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <p className="font-['Noto_Sans_JP:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#1b1b1b] text-[18px] text-center tracking-[-0.3125px] whitespace-nowrap">はじめる</p>
    </div>
  );
}
